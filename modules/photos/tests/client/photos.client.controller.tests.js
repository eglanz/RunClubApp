  ...
  describe('Photos Controller Tests', function () {
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _PhotosService_) {
      ...
      Authentication.user = {
       ...
       /*PhotosController.factory('photoResolve', function () {
        return {
          title: "StarCraft"
        };
      });*/
    ...
    describe('vm.upload()', function(){
      ...
      /*beforeEach(function() {
        var document = angular.element(document); // This is exactly what Angular does
        document.find('body').append('<button type="submit" id="submitbtn"></button>');
