    ...
    describe('Route Config', function () {
      ...
      describe('Create Route', function () {
        ...
        beforeEach(inject(function ($controller, $state, $templateCache) {
          ...
          $templateCache.put('modules/locations/client/views/create-location.client.view.html', '');
        ...
        it('Should have templateUrl', function () {
          expect(createstate.templateUrl).toBe('modules/locations/client/views/create-location.client.view.html');
        });
      });

      //if we add and edit route
